 ...
 */
final class Version20250630141731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE pokemon_card ADD category VARCHAR(255) NOT NULL, ADD rarity_symbol VARCHAR(255) NOT NULL, ADD rarity_text VARCHAR(255) NOT NULL, ADD is_reverse_possible TINYINT(1) NOT NULL, ADD sub_serie VARCHAR(255) DEFAULT NULL, DROP holo, DROP reverse, DROP created_at, DROP updated_at, CHANGE star_rating extension_id INT NOT NULL, CHANGE rarity api_id VARCHAR(255) NOT NULL, CHANGE extension special_type VARCHAR(255) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE pokemon_card ADD rarity VARCHAR(255) NOT NULL, ADD reverse TINYINT(1) NOT NULL, ADD created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', ADD updated_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', ADD extension VARCHAR(255) DEFAULT NULL, DROP api_id, DROP category, DROP special_type, DROP rarity_symbol, DROP rarity_text, DROP sub_serie, CHANGE extension_id star_rating INT NOT NULL, CHANGE is_reverse_possible holo TINYINT(1) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
